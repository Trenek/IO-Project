...
void InitializeCharacterCreator(struct characterCreator* element, struct menuInfo* info) {
    ...
    bodyPartsInPolish[HEAD] = "G³owa";
    bodyPartsInPolish[LEFT_ARM] = "Lewe ramiê";
    bodyPartsInPolish[RIGHT_ARM] = "Prawie ramiê";
    bodyPartsInPolish[LEFT_FOOT] = "Lewa stopa";
    bodyPartsInPolish[RIGHT_FOOT] = "Prawa stopa";
    bodyPartsInPolish[LEFT_HAND] = "Lewa d³oñ";
    bodyPartsInPolish[RIGHT_HAND] = "Prawa d³oñ";
    bodyPartsInPolish[LEFT_LEG] = "Lewa noga";
    bodyPartsInPolish[RIGHT_LEG] = "Prawa d³oñ";
    bodyPartsInPolish[TORSO] = "Tors";
    ...
    char* armorPartsInPolish[9];
    armorPartsInPolish[HELMET] = "He³m";
    armorPartsInPolish[BREASTPLATE] = "Napierœnik";
    armorPartsInPolish[PANTS] = "Spodnie";
    armorPartsInPolish[LEFT_BOOT] = "Lewy but";
    armorPartsInPolish[RIGHT_BOOT] = "Prawy but";
    armorPartsInPolish[LEFT_GLOVE] = "Lewa rêkawica";
    armorPartsInPolish[RIGHT_GLOVE] = "Prawa rêkawica";
    armorPartsInPolish[LEFT_SLEEVE] = "Lewy rêkaw";
    armorPartsInPolish[RIGHT_SLEEVE] = "Prawy rêkaw";
