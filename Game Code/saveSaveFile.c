...
static void SaveWeapon(FILE *playerFile, struct character *character) {
    fprintf(playerFile, "%i\n\n", character->weapon);
}

static void SaveCharacterAttacks(FILE *playerFile, struct character *character) {
    int i = 0;
...
static void SaveCharacter(struct character *character, const char *characterSave) {
    ...
    SaveWeapon(playerFile, character);

    SaveCharacterAttacks(playerFile, character);
